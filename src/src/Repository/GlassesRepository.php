...
/**
 * @extends ServiceEntityRepository<Glasses>
 *
...
class GlassesRepository extends ServiceEntityRepository
{
    ...
    public function add(Glasses $entity, bool $flush = false): void
    {
    ...
    public function remove(Glasses $entity, bool $flush = false): void
    {
