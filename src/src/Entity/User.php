...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @return Collection<int, GlassesStore>
     */
    public function getGlassesStores(): Collection
    {
        return $this->glassesStores;
    }

    public function addGlassesStore(GlassesStore $glassesStore): self
    {
    ...
    public function removeGlassesStore(GlassesStore $glassesStore): self
    {
